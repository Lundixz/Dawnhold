...
def make_perfect_seamless_diamond(src_path, dest_path, feather_start=0.92, feather_end=0.99):
    print(f"Converting {src_path} to perfect narrow-feathered diamond tile...")
...
try:
    make_perfect_seamless_diamond(src_sand, dest_sand, feather_start=0.92, feather_end=0.99)
    make_perfect_seamless_diamond(src_water, dest_water, feather_start=0.92, feather_end=0.99)
