...
def make_soft_seamless_diamond(src_path, dest_path, feather_start=0.1, feather_end=0.98):
    print(f"Converting {src_path} to soft seamless diamond tile...")
    ...
    print(f"Successfully saved soft tile to {dest_path}")
...
dest_water = r"d:\Program\Dawnhold\frontend\public\v2_assets\water_tile_soft.png"

try:
    make_soft_seamless_diamond(src_sand, dest_sand, feather_start=0.1, feather_end=0.98)
    make_soft_seamless_diamond(src_water, dest_water, feather_start=0.1, feather_end=0.98)
